...
const generalSection = {
    ...
    fields: [
        ...
        },
        {
            ...
            label: "Unidade de Saúde (ou outra fonte)",
            kind: "text",
...
// -----------------------------------------------------------------------------
// 4. DADOS COMPLEMENTARES E ANTECEDENTES (Campos 31 a 38)
// -----------------------------------------------------------------------------
const complementarySection = {
    ...
    fields: [
        ...
        {
            name: "st_sentinel_unit",
            label: "A Unidade Notificante é Sentinela?",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
        ...
        },
        {
            ...
            options: [
                ...
                { label: "5 - Três + Dois Reforços", value: "5" },
...
// -----------------------------------------------------------------------------
// 5. DADOS CLÍNICOS E SINTOMAS (Campos 39 a 41)
// -----------------------------------------------------------------------------
const symptomsSection = {
    ...
    fields: [
        {
            name: "dt_cough_onset",
            label: "Data do Início da Tosse",
            kind: "date",
            schema: optionalTextSchema,
            defaultValue: "",
        },
        {
            name: "st_symptom_cough",
            label: "Tosse",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
        ...
        {
            name: "st_symptom_paroxysmal_cough",
            label: "Tosse Paroxística",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
            options: yesNoUnknownOptions,
        ...
        {
            name: "st_comp_pneumonia",
            label: "Complicação: Pneumonia/Broncopneumonia",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
            options: yesNoUnknownOptions,
        ...
        {
            name: "st_comp_dehydration",
            label: "Complicação: Desidratação",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
            options: yesNoUnknownOptions,
        ...
        {
            name: "st_comp_malnutrition",
            label: "Complicação: Desnutrição",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
            options: yesNoUnknownOptions,
        ...
        {
            name: "st_comp_encephalopathy",
            label: "Complicação: Encefalopatia",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
            options: yesNoUnknownOptions,
...
// -----------------------------------------------------------------------------
// 6. ATENDIMENTO E TRATAMENTO (Campos 42 a 49)
// -----------------------------------------------------------------------------
const attendanceSection = {
    ...
    fields: [
        ...
        {
            name: "st_used_antibiotic",
            label: "Utilizou Antibiótico?",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
            options: yesNoUnknownOptions,
...
// -----------------------------------------------------------------------------
// 7. DADOS DO LABORATÓRIO (Campos 50 a 51)
// -----------------------------------------------------------------------------
const laboratorySection = {
    ...
    fields: [
        {
            name: "dt_material_collection",
            label: "Data da Coleta de Material",
            kind: "date",
            schema: optionalTextSchema,
            defaultValue: "",
        },
        {
            name: "st_nasopharyngeal_collection",
            label: "Coleta de Material da Nasofaringe?",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
            options: yesNoUnknownOptions,
...
// -----------------------------------------------------------------------------
// 8. COMUNICANTES E MEDIDAS DE CONTROLE (Campos 52 a 58)
// -----------------------------------------------------------------------------
const controlMeasuresSection = {
    ...
    fields: [
        ...
        {
            name: "st_nasopharyngeal_collection_contacts",
            label: "Realizada Coleta da Nasofaringe (Comunicantes)?",
            kind: "select",
            schema: optionalTextSchema,
            defaultValue: "9",
            options: yesNoUnknownOptions,
        ...
        {
            name: "nu_positive_culture_contacts",
            label: "Resultados Positivos na Cultura (Comunicantes)?",
            kind: "text",
            schema: optionalTextSchema,
            defaultValue: "",
        },
...
// -----------------------------------------------------------------------------
// 9. CONCLUSÃO DO CASO (Campos 59 a 64 e Observações)
// -----------------------------------------------------------------------------
    ...
    fields: [
        ...
        },
        {
            ...
            options: [
                ...
                { label: "2 - Óbito por coqueluche", value: "2" },
